...
ggplot(data = penguins, 
       mapping = aes(x = bill_length_mm, y = bill_depth_mm, color = species)) + # Scaling 
  geom_point() +
  scale_color_manual(values = c("maroon", "navy", ("darkorange3")))
...
#| warning: false
ggplot(data = penguins, 
       mapping = aes(x = bill_length_mm, y = bill_depth_mm, color = body_mass_g)) + # Scaling 
  geom_point() +
  scale_color_gradient(low = "maroon", high = "blue")
```

```{r}
ggplot(data = penguins, 
       mapping = aes(x = bill_length_mm, y = bill_depth_mm)) + # Scaling 
...
ggplot(penguins, aes(x = species)) +
  ...
  theme_linedraw() +
  theme(
  axis.title = element_text(size = 45, color = "maroon3")
  )
```
...
ggplot(penguins, aes(x = flipper_length_mm, fill = species)) +
  ...
  scale_fill_manual(values = c("maroon4", "navy", "yellow3")) +
